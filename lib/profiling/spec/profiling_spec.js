...
import { configuration } from 'laxar';
...
describe( 'A Profiling module', () => {
   ...
   it( 'fetches its configuration with defensive defaults', () => {
      spyOn( configuration, 'get' );
      $injector.invoke( runBlock, null, { $window: windowMock } );

      expect( configuration.get ).toHaveBeenCalledWith( 'profiling.enabled', false );
   } );

   ////////////////////////////////////////////////////////////////////////////////////////////////////////

   it( 'when disabled returns early', () => {
      window.laxar.profiling.enabled = false;
      $injector.invoke( runBlock, null, { $window: windowMock } );
