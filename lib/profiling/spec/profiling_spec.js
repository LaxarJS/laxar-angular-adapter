...
describe( 'A Profiling module', () => {
   ...
   function setupExampleWatchers() {
      ...
      scope1.$watch( 'thing1', listener1 );
      function listener1() {}

      scope11 = scope1.$new();
      scope11.$watch( 'thing11', listener11 );
      function listener11() {}

      scope2 = $rootScope.$new();
      scope2.$watch( 'thing2', listener2 );
      function listener2() {}
   ...
   beforeEach( () => {
      ...
      configurationValues = {};
      configuration = createAxConfigurationMock( configurationValues );
   ...
   describe( 'when enabled without performance API', () => {
